...
public class Tabla {
    ...
    private ArrayList<TableRow> filasTabla; // Array de las filas de la tabla
    private Activity actividad;
    private Resources rs;
    private int filas;
    private int columnas; // Filas y columnas de nuestra tabla
    ...
    public Tabla(Activity actividad, TableLayout tabla)
    {
        ...
        filas = columnas = 0;
        filasTabla = new ArrayList<TableRow>();
    }
    ...
    public void agregarFilaTabla(ArrayList<String> elementos)
    {
        ...
        for(int i = 0; i< elementos.size(); i++)
        {
            ...
            if (i == elementos.size() - 1) {
                double cantidad = Double.parseDouble(elementos.get(i));
                if (cantidad >= 0) texto.setTextColor(Color.GREEN);
                else texto.setTextColor(Color.RED);
                texto.setText(Double.toString(Math.abs(cantidad)) + "€");
            }
